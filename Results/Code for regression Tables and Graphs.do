...
logit NewPro c.lognl c.lognl#c.lognl age medium large laggedGDPpc i.regiondummy i.endyear if city!="" & conflict==0 
...
logit NewEst c.lognl c.lognl#c.lognl age medium large laggedGDPpc i.regiondummy i.endyear if city!="" & conflict==0 
outreg2 using results1.doc, keep (c.lognl c.lognl#c.lognl age medium large laggedGDPpc) append  dec(3)  addtext(Method, Logit, Conflict, Exclude, GDPpc>30000, Exclude, Region FE, Yes, Year FE, Yes,  R-squared, NA)  addstat(Pseudo R2, e(r2_p)) stat(coef pval ci)

logit RND c.lognl c.lognl#c.lognl laggedGDPpc age medium large i.regiondummy i.endyear if city!="" & conflict==0 
outreg2 using results1.doc, keep (c.lognl c.lognl#c.lognl age medium large laggedGDPpc) append  dec(3)  addtext(Method, Logit, Conflict, Exclude, GDPpc>30000, Exclude, Region FE, Yes, Year FE, Yes,  R-squared, NA)  addstat(Pseudo R2, e(r2_p)) stat(coef pval ci)

ologit innovation c.lognl c.lognl#c.lognl age medium large laggedGDPpc i.regiondummy i.endyear if city!="" & conflict==0 
outreg2 using results1.doc, keep (c.lognl c.lognl#c.lognl age medium large laggedGDPpc) append  dec(3)  addtext(Method, Logit, Conflict, Exclude, GDPpc>30000, Exclude, Region FE, Yes, Year FE, Yes,  R-squared, NA)  addstat(Pseudo R2, e(r2_p)) stat(coef pval ci)
